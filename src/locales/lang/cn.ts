export default {
  ...
  user: {
    ...
    password: "密码",
    modify: "修改",
    please_fill_all_required: "请填写所有必填项",
    register_success: "注册成功",
    register_failed: "注册失败，请稍后重试",
    email_format_error: "请输入有效的邮箱地址",
    username_length_error: "用户名长度不能少于3个字符",
    full_name_length_error: "姓名长度不能少于6个字符",
    password_length_error: "密码长度不能少于6个字符",
    delete_success: "删除成功",
    delete_failed: "删除失败",
  },
  common: {
  ...
  device_search: {
    ...
    version: "版本",
    search_success: "搜索成功",
    no_devices_found: "未搜索到设备",
    request_failed: "请求失败",
    search_error: "搜索异常，请重试",
    msg_1: "更新菜单失败，请重试!",
    msg_2: "未进行任何修改!",
    msg_8: '成功删除 "{delnum}" 个设备，新增 "{addnum}" 个设备!',
    msg_9: '成功删除 "{delnum}" 个设备!',
    msg_10: '成功添加 "{addnum}" 个设备!',
    please_select_network_interface: "请选择网络接口",
    network_interface_fetch_failed: "获取网络接口失败",
    no_network_interfaces: "未检测到可用网络接口",
    network_request_error: "网络请求异常，请稍后重试",
  },
  device_info: {
    del_device: "删除设备",
    modify_device_address: "网络设置",
    lan0_config: "LAN0 配置",
    lan1_config: "LAN1 配置",
    ip_address: "IP地址",
    gateway: "网关",
    subnet_mask: "子网掩码",
    please_enter_ip: "请输入IP地址",
    please_enter_mask: "请输入子网掩码",
    please_enter_gw: "请输入网关地址",
    ip_format_error: "IP地址格式不正确",
    mask_format_error: "子网掩码格式不正确",
    gw_format_error: "网关格式不正确",
    modify_success: "修改成功，设备正在重启...",
    modify_failed: "网络配置修改失败",
    save_network_config_error: "保存网络配置失败，请检查网络或设备状态",
  },
  firmware: {
    title: "固件更新",
    select_btn: "选择",
  ...
  mqtt: {
    ...
    modal_title: "添加Topic",
    serial_number: "分组",
    controller_not_found: "未找到对应控制器信息",
    host_port_required: "请填写MQTT主机和端口",
    save_success: "保存成功",
    max_limit_3: "最多只能添加10个Topic",
    ...
    client_key: "客户端密钥",
    ca_cert_placeholder: "点击上传CA证书",
    client_cert_placeholder: "点击上传客户端证书",
    client_key_placeholder: "点击上传客户端密钥",
    ca_upload_success: "CA证书上传成功",
    ca_upload_fail: "CA证书上传失败",
    client_cert_upload_success: "客户端证书上传成功",
  ...
  msg: {
    ...
    config_unzip_failed: "解压远程文件失败",
    config_no_update: "配置文件无更新，已是最新版本",
    ...
    data_set_no_writable: "已被连接，点位设置不可写。检查通过",
    clear_success: "清空成功",
